...
from embedia_export.embedia.model_generator.models import create_model_template_c, create_main_template_c, format_model_name
from embedia_export.embedia.model_generator.utils.generator_utils import create_codeblock_project
from embedia_export.embedia.project_options import ModelDataType, ProjectType, ProjectFiles, DebugMode
    


class ProjectGenerator:
    _dst_folder = None
    _root_folder = 'embedia_export/libraries/'
